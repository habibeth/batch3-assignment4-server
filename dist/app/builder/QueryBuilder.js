...
class QueryBuilder {
    ...
    filter() {
        ...
        // Filtering
        const excludeFields = ['searchTerm', 'sort', 'limit', 'page', 'fields', 'priceOrder'];
    ...
    sort() {
        ...
        const priceOrder = (_d = this === null || this === void 0 ? void 0 : this.query) === null || _d === void 0 ? void 0 : _d.priceOrder;
        if (priceOrder) {
            this.modelQuery = this.modelQuery.sort({ price: priceOrder });
        }
        else {
